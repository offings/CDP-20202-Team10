...
public class SignUpActivity extends AppCompatActivity {
    ...
    public class signUpOnClick implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            edit_address.setHorizontallyScrolling(false);//자동줄바꿈
            ...
            if(!bizNumValidator(bizNum)){
                ...
                {
                    Toast.makeText(SignUpActivity.this,"인터넷을 연결해주십시오",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String postParameters = "mb_id="+mb_id+"&mb_name=" + mb_name + "&mb_password="+mb_password + "&mb_email="+mb_email+"&mb_hp="+mb_hp+"&mb_addr1="+mb_addr1;
