...
/*
        ...
        span.setSpan(new ForegroundColorSpan(getColor(R.color.senior_btn_color)), 0, 3, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
        span.setSpan(new RelativeSizeSpan(1.1f), 0, 3, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
    ...
    public void onClick(View v){
        switch(v.getId()){
            case R.id.btn_soft:
                menu_option = menu_option.concat("연하게, ");
                if(category_num == 1){
            ...
            case R.id.btn_normal:
                menu_option = menu_option.concat("진하기 보통, ");
                if(category_num == 1){
                    Intent intent = new Intent(this, Senior_MenuOption_SizeSelect.class);
                    intent.putExtra("category",category_num);
                    intent.putExtra("menu_image",menu_image);
            ...
            case R.id.btn_thick:
                menu_option = menu_option.concat("진하게, ");
                if(category_num == 1){
                    Intent intent = new Intent(this, Senior_MenuOption_SizeSelect.class);
                    intent.putExtra("category",category_num);
                    intent.putExtra("menu_image",menu_image);
            ...
            case R.id.btn_more_thick:
                menu_option = menu_option.concat("매우 진하게, ");
                if(category_num == 1){
                    Intent intent = new Intent(this, Senior_MenuOption_SizeSelect.class);
                    intent.putExtra("category",category_num);
                    intent.putExtra("menu_image",menu_image);
